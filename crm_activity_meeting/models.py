...
class crm_activity(models.Model):
    ...
    def action_schedule_meeting(self):
        """
        Open meeting's calendar view to schedule crm_activity_meeting on current opportunity.
        :return dict: dictionary value for created Meeting view
        """
        lead = self
        activity_type_id = self.env.ref('crm_activity_meeting.crm_activity_type_new_meeting_r0').id
